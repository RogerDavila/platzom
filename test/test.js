...
describe('#platzom', function () {
  ...
  it('Si la palabra inicia co Z, se le añade "pe" al final.', function () {
  ...
  it('Por últmo, si la palabra original es un palíndromo, ninguna regla anterior cuenta y se devuelve la misma palabra pero   intercalando letras mayúsculas y minúsculas.', function () {
